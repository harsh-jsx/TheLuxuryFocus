            ...
            >
                ...
                <div className="flex items-center gap-4 sm:gap-6 lg:gap-8 relative z-1000">
                    ...
                    <button
                        ...
                        className="font-[ABC] text-[11px] sm:text-xs uppercase tracking-widest hover:opacity-70 active:opacity-80 transition-opacity min-w-[44px] min-h-[44px] flex items-center justify-end text-right group relative z-50"
                    >
