...
const Signup = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen bg-[#0a0a0a] text-[#E4E0D9] flex items-center justify-center px-4 relative overflow-hidden"
    >
      ...
      <div className="w-full max-w-[450px] relative z-10 py-10 text-center">
        <div className="mb-10">
          <h1 className="signup-title font-[Albra] text-5xl md:text-6xl mb-4">
            Create Account
          </h1>
        ...
        <button
          ...
          className="signup-btn w-full bg-white text-[#0a0a0a] font-[Albra] text-xl py-4 rounded-lg hover:bg-gray-200 transition-colors flex items-center justify-center gap-3"
        >
