    ...
    if (loading) {
        return (
            <div className="min-h-screen w-full flex flex-col items-center justify-center bg-white text-gray-900">
                ...
                <p className="font-[ABC] text-xs uppercase tracking-widest text-gray-500">Curating Experience...</p>
            </div>
        );
    }
        ...
        <div ref={containerRef} className="min-h-screen bg-white text-gray-900 overflow-x-hidden">
            ...
            >
                ...
                <div className="absolute top-8 right-6 md:right-12 z-20 flex gap-3">
                    <button className="p-3 bg-white/10 backdrop-blur-md text-white rounded-full hover:bg-white hover:text-gray-900 transition-all">
                        <Share2 size={20} />
                    </button>
                    <button className="p-3 bg-white/10 backdrop-blur-md text-white rounded-full hover:bg-white hover:text-gray-900 transition-all">
                        <Star size={20} />
            ...
            <div className="relative z-30 px-6 md:px-12 -mt-24 md:-mt-32 pb-12">
                ...
                >
                    ...
                    <div className="flex-1 text-center md:text-left">
                        ...
                        <div className="flex flex-wrap items-center justify-center md:justify-start gap-6 text-gray-600 font-[ABC] text-sm">
                            <span className="flex items-center gap-2">
                                <MapPin size={16} className="text-[#D0B887]" /> {store.storeCity}
                                {store.storeState && `, ${store.storeState}`}
                            </span>
                            {store.openingHours && (
                                <span className="flex items-center gap-2">
                                    <Clock size={16} className="text-[#D0B887]" /> {store.openingHours}
                                </span>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="shrink-0 flex flex-col gap-4">
                        <button className="bg-gray-900 text-white px-10 py-5 rounded-2xl font-[ABC] text-xs uppercase tracking-widest hover:bg-gray-800 transition-colors flex items-center gap-3">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {store.storeServices.map((service, idx) => (
                                    ...
                                    >
                                        ...
                                        <span className="font-[ABC] text-sm tracking-wide">{service}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div ref={(el) => { contentRefs.current[2] = el }}>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                {store.galleryUrls.map((url, idx) => (
                                    <div
                                        key={idx}
                                        className={`rounded-2xl overflow-hidden border border-gray-100 group ${idx % 3 === 0 ? 'md:col-span-2 h-[420px]' : 'h-[320px]'
                                            }`}
                                    >
                                        <img
                                            src={url}
                ...
                <div className="space-y-8">
                    ...
                    >
                        <div>
                            ...
                            <p className="text-xl font-[Albra] text-gray-900">Bespoke Tradition</p>
                        </div>
                        ...
                        <div>
                            ...
                            <button className="flex items-center gap-2 font-[ABC] text-xs text-[#D0B887] mt-4 hover:gap-3 transition-all">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                {['Premium Verification', 'Priority Support', 'Exclusive Access'].map((item) => (
                                    <li key={item} className="flex items-center gap-3 font-[ABC] text-xs text-gray-600">
                                        <div className="w-1.5 h-1.5 rounded-full bg-[#D0B887]" /> {item}
                                    </li>
                                ))}
                            </ul>
                        </div>
                    ...
                    >
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">
                            Get priority access to their upcoming collections and seasonal experiences.
                        </p>
