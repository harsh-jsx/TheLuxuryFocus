...
const categories = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1554118811-1e0d58224f24?q=80&w=1947&auto=format&fit=crop",
...
const luxuryCategories = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1566073771259-6a8506099945?q=80&w=2070&auto=format&fit=crop",
    desc: "5-star hotels, boutique stays, and private villas.",
    color: "#8b5cf6",
    shapeClass: "rounded-[48px] rounded-tr-[90px]",
  },
  {
    id: "l2",
    title: "Restaurants & Fine Dining",
    filterCategory: "Restaurants & Fine Dining",
    icon: Utensils,
    image:
      "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?q=80&w=2070&auto=format&fit=crop",
    desc: "Michelin-style dining and celebrity-chef concepts.",
    color: "#dc2626",
    shapeClass: "rounded-[48px] rounded-bl-[90px]",
  },
  {
    id: "l3",
    title: "Travel & Tourism",
    filterCategory: "Travel & Tourism",
    icon: Plane,
    image:
      "https://images.unsplash.com/photo-1501785888041-af3ef285b470?q=80&w=2070&auto=format&fit=crop",
  ...
  },
  {
    ...
    color: "#f97316",
    shapeClass: "rounded-[42px] rounded-tr-[78px]",
  },
  {
    id: "l5",
    title: "Jewelry & Watches",
    filterCategory: "Jewelry & Watches",
    icon: Gem,
    image:
      "https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?q=80&w=2065&auto=format&fit=crop",
    desc: "High-end jewelry, watches, and bespoke creations.",
    color: "#d4af37",
    shapeClass: "rounded-[48px] rounded-tl-[90px]",
  },
  {
    id: "l6",
    title: "Real Estate",
    ...
    color: "#0ea5e9",
    shapeClass: "rounded-[48px] rounded-br-[88px]",
  },
  {
    id: "l7",
    title: "Automobiles",
    filterCategory: "Automobiles",
    icon: Car,
    image:
    ...
    color: "#ef4444",
    shapeClass: "rounded-[52px] rounded-tr-[92px]",
  },
  {
    id: "l8",
    title: "Yachts & Aviation",
    filterCategory: "Yachts & Aviation",
    icon: Ship,
    image:
      "https://images.unsplash.com/photo-1569263979104-865ab7cd8d13?q=80&w=2070&auto=format&fit=crop",
    desc: "Private yachts, jets, and charter experiences.",
    color: "#14b8a6",
    shapeClass: "rounded-[50px] rounded-bl-[92px]",
  },
  {
    id: "l9",
    title: "Beauty & Wellness",
    filterCategory: "Beauty & Wellness",
    icon: HeartPulse,
    image:
      "https://images.unsplash.com/photo-1540555700478-4be289fbecef?q=80&w=1974&auto=format&fit=crop",
    desc: "Spas, salons, and premium wellness retreats.",
    color: "#ec4899",
    shapeClass: "rounded-[48px] rounded-tl-[80px]",
  },
  {
    id: "l10",
    title: "Art & Collectibles",
    filterCategory: "Art & Collectibles",
    icon: Palette,
    image:
    ...
    color: "#7c3aed",
    shapeClass: "rounded-[54px]",
  },
  {
    id: "l11",
    title: "Event Management",
    filterCategory: "Event Management",
    icon: PartyPopper,
    image:
    ...
    color: "#22c55e",
    shapeClass: "rounded-[46px] rounded-br-[84px]",
  },
  {
    id: "l12",
    title: "Private Clubs & Lifestyle",
    filterCategory: "Private Clubs & Lifestyle",
    icon: Crown,
    image:
    ...
    color: "#f59e0b",
    shapeClass: "rounded-[50px] rounded-tr-[90px]",
  },
  {
    id: "l13",
    title: "Finance & Wealth Management",
    filterCategory: "Finance & Wealth Management",
    icon: Landmark,
    image:
      "https://images.unsplash.com/photo-1565514020179-026b92b4a906?q=80&w=2069&auto=format&fit=crop",
    desc: "Private banking and wealth advisory firms.",
    color: "#334155",
    shapeClass: "rounded-[52px] rounded-bl-[84px]",
  },
  {
    id: "l14",
    title: "Technology & Gadgets",
    filterCategory: "Technology & Gadgets",
    icon: Laptop,
    image:
      "https://images.unsplash.com/photo-1518770660439-4636190af475?q=80&w=2070&auto=format&fit=crop",
    desc: "Premium electronics and bespoke smart tech.",
    color: "#0ea5e9",
    shapeClass: "rounded-[48px] rounded-tl-[86px]",
  },
  {
    id: "l15",
    title: "Education & Training",
    filterCategory: "Education & Training",
    icon: GraduationCap,
    image:
    ...
    color: "#3b82f6",
    shapeClass: "rounded-[46px] rounded-br-[78px]",
  },
  {
    id: "l16",
    title: "Health & Medical",
    filterCategory: "Health & Medical",
    icon: HeartPulse,
    image:
    ...
    color: "#16a34a",
    shapeClass: "rounded-[52px] rounded-tr-[86px]",
  },
  {
    id: "l17",
    title: "Legal Services",
    filterCategory: "Legal Services",
    icon: Scale,
    image:
  ...
  },
  {
    ...
    filterCategory: "Interior Design & Architecture",
    icon: Paintbrush,
    image:
  ...
  },
  {
    ...
    filterCategory: "Pet Care & Services",
    icon: PawPrint,
    image:
    ...
    color: "#a855f7",
    shapeClass: "rounded-[44px] rounded-tr-[84px]",
  },
  {
    id: "l20",
    title: "Gifting & Luxury Services",
    filterCategory: "Gifting & Luxury Services",
    icon: Gift,
    image:
    ...
    color: "#e11d48",
    shapeClass: "rounded-[50px] rounded-br-[90px]",
  },
];
...
const Categories = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen bg-white py-32 px-6 overflow-hidden"
    >
      ...
      <p className="max-w-3xl mx-auto text-center text-gray-500 font-[ABC] text-sm md:text-base mb-14">
        Choose a category to view matching stores instantly. Don't see your
        business type? Use{" "}
        ...
        {mergedCategories.map((cat, index) => {
          ...
          return (
            ...
            >
              ...
              <div
                className={`absolute inset-0 border-8 border-white z-20 ${cat.shapeClass} pointer-events-none`}
              ></div>
              ...
              <div className="absolute top-6 left-6 z-30">
                <div
                  className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-black shadow-lg transform group-hover:scale-110 group-hover:rotate-12 transition-all duration-300"
              ...
              <div className="absolute bottom-6 right-6 z-30">
                ...
                <div
                  className="w-12 h-12 bg-white flex items-center justify-center shadow-lg transform group-hover:scale-110 transition-transform duration-300 rounded-full rounded-bl-sm"
                  style={{ backgroundColor: cat.color, color: "white" }}
                >
                  <span className="font-bold text-sm font-[ABC]">
                    {cat.count ?? 0}
                  </span>
                </div>
                {/* Small pointer decoration */}
                <div
                  className="absolute -bottom-1 -left-1 w-4 h-4 rounded-full -z-10"
              ...
              <div
                className={`absolute inset-0 ${cat.shapeClass} border border-white/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 pointer-events-none`}
              ></div>
            </div>
          );
        })}
