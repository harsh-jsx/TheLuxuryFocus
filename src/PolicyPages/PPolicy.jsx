  ...
  <div className="max-w-7xl mx-auto px-4 py-8">
    ...
    <div className="space-y-6 text-sm leading-relaxed">
      <section>
        ...
        <p>
          TheLuxuryFocus.com ("we," "our," or "us") is committed to protecting
      ...
      <section>
        ...
        <h3 className="text-lg font-medium mb-2">4.1 Legal Requirements</h3>
        <p>
          We may disclose your information when required by law, regulation, or
          legal process.
        </p>
        ...
        <h3 className="text-lg font-medium mb-2">4.4 Protection of Rights</h3>
        <p>
      ...
      <section>
        ...
        <p>
          ...
          our agreements. Specific retention periods vary based on the type of
      ...
      <div className="mt-8 p-4 bg-gray-100 rounded-lg dark:bg-gray-800 dark:text-white">
        ...
        <p className="text-sm dark:text-white mt-2">
          ...
          applies to all users of our platform and services.
        </p>
      </div>
    </div>
  </div>
